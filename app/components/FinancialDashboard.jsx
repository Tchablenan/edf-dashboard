...
import { 
  TrendingUp, TrendingDown, DollarSign, Activity, Target, AlertCircle,
  AlertTriangle, CheckCircle2, Clock, Zap, Menu, X
} from 'lucide-react';
...
const ActionItem = ({ action, expanded, onExpand }) => (
  <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-4 mb-3 border-l-4 border-blue-500">
    <button
      onClick={() => onExpand(expanded === action.step ? null : action.step)}
